...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 15, 2019 at 01:11 PM
...
INSERT INTO `city` (`ID`, `City`, `CountryCode`, `State`, `Population`) VALUES
...
CREATE TABLE `country` (
  ...
  `CountryName` varchar(44) DEFAULT NULL,
  `Continent` varchar(13) DEFAULT NULL,
  `Region` varchar(25) DEFAULT NULL,
  `Area` int(8) DEFAULT NULL,
  `independence` int(18) DEFAULT NULL,
  `population` int(10) DEFAULT NULL,
  `LifeExpectancy` float DEFAULT NULL,
  `GNP` int(7) DEFAULT NULL,
  `GNPOld` int(7) DEFAULT NULL,
  `Pronunciation` varchar(44) DEFAULT NULL,
  `TypeOfPoliticalPower` varchar(44) DEFAULT NULL,
  `President` varchar(33) DEFAULT NULL,
  `Capital` int(4) DEFAULT NULL,
  `InternetDomainCode` varchar(18) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `country` (`CountryCode`, `CountryName`, `Continent`, `Region`, `Area`, `independence`, `population`, `LifeExpectancy`, `GNP`, `GNPOld`, `Pronunciation`, `TypeOfPoliticalPower`, `President`, `Capital`, `InternetDomainCode`) VALUES
('ABW', 'Aruba', 'North America', 'Caribbean', 193, 0, 103000, 78.4, 828, 793, 'Aruba', 'Nonmetropolitan Territory of The Netherlands', 'Beatrix', 129, 'AW'),
('AFG', 'Afghanistan', 'Asia', 'Southern and Central Asia', 652090, 1919, 22720000, 45.9, 5976, 0, 'Afganistan/Afqanestan', 'Islamic Emirate', 'Mohammad Omar', 1, 'AF'),
('AGO', 'Angola', 'Africa', 'Central Africa', 1246700, 1975, 12878000, 38.3, 6648, 7984, 'Angola', 'Republic', 'José Eduardo dos Santos', 56, 'AO'),
('AIA', 'Anguilla', 'North America', 'Caribbean', 96, 0, 8000, 76.1, 63, 0, 'Anguilla', 'Dependent Territory of the UK', 'Elisabeth II', 62, 'AI'),
('ALB', 'Albania', 'Europe', 'Southern Europe', 28748, 1912, 3401200, 71.6, 3205, 2500, 'Shqipëria', 'Republic', 'Rexhep Mejdani', 34, 'AL'),
('AND', 'Andorra', 'Europe', 'Southern Europe', 468, 1278, 78000, 83.5, 1630, 0, 'Andorra', 'Parliamentary Coprincipality', '', 55, 'AD'),
...
('ATA', 'Antarctica', 'Antarctica', 'Antarctica', 13120000, 0, 0, 0, 0, 0, '–', 'Co-administrated', '', 0, 'AQ'),
('ATF', 'French Southern territories', 'Antarctica', 'Antarctica', 7780, 0, 0, 0, 0, 0, 'Terres australes françaises', 'Nonmetropolitan Territory of France', 'Jacques Chirac', 0, 'TF'),
...
('AUS', 'Australia', 'Oceania', 'Australia and New Zealand', 7741220, 1901, 18886000, 79.8, 351182, 392911, 'Australia', 'Constitutional Monarchy', '', 0, ''),
...
('BEL', 'Belgium', 'Europe', 'Western Europe', 30518, 1830, 10239000, 77.8, 249704, 243948, 'België/Belgique', 'Constitutional Monarchy', '', 0, ''),
...
('BIH', 'Bosnia and Herzegovina', 'Europe', 'Southern Europe', 51197, 1992, 3972000, 71.5, 2841, 0, 'Bosna i Hercegovina', 'Federal Republic', 'Ante Jelavic', 201, 'BA'),
('BLR', 'Belarus', 'Europe', 'Eastern Europe', 207600, 1991, 10236000, 68, 13714, 0, 'Belarus', 'Republic', 'Aljaksandr Lukašenka', 3520, 'BY'),
...
('BMU', 'Bermuda', 'North America', 'North America', 53, 0, 65000, 76.9, 2328, 2190, 'Bermuda', 'Dependent Territory of the UK', 'Elisabeth II', 191, 'BM'),
...
('BVT', 'Bouvet Island', 'Antarctica', 'Antarctica', 59, 0, 0, 0, 0, 0, 'Bouvetøya', 'Dependent Territory of Norway', 'Harald V', 0, 'BV'),
...
('CAN', 'Canada', 'North America', 'North America', 9970610, 1867, 31147000, 79.4, 598862, 625626, 'Canada', 'Constitutional Monarchy', '', 0, ''),
('CCK', 'Cocos (Keeling) Islands', 'Oceania', 'Australia and New Zealand', 14, 0, 600, 0, 0, 0, 'Cocos (Keeling) Islands', 'Territory of Australia', 'Elisabeth II', 2317, 'CC'),
...
('COD', 'Congo', '', '', 0, 0, 0, 0, 0, 0, '', '', '', 0, ''),
('COG', 'Congo', 'Africa', 'Central Africa', 342000, 1960, 2943000, 47.4, 2108, 2287, 'Congo', 'Republic', 'Denis Sassou-Nguesso', 2296, 'CG'),
('COK', 'Cook Islands', 'Oceania', 'Polynesia', 236, 0, 20000, 71.1, 100, 0, 'The Cook Islands', 'Nonmetropolitan Territory of New Zealand', 'Elisabeth II', 583, 'CK'),
...
('CXR', 'Christmas Island', 'Oceania', 'Australia and New Zealand', 135, 0, 2500, 0, 0, 0, 'Christmas Island', 'Territory of Australia', 'Elisabeth II', 1791, 'CX'),
('CYM', 'Cayman Islands', 'North America', 'Caribbean', 264, 0, 38000, 78.9, 1263, 1186, 'Cayman Islands', 'Dependent Territory of the UK', 'Elisabeth II', 553, 'KY'),
...
('ESH', 'Western Sahara', 'Africa', 'Northern Africa', 266000, 0, 293000, 49.8, 60, 0, 'As-Sahrawiya', 'Occupied by Marocco', 'Mohammed Abdel Aziz', 2453, 'EH'),
...
('FLK', 'Falkland Islands', 'South America', 'South America', 12173, 0, 2000, 0, 0, 0, 'Falkland Islands', 'Dependent Territory of the UK', 'Elisabeth II', 763, 'FK'),
('FRA', 'France', 'Europe', 'Western Europe', 551500, 843, 59225700, 78.8, 1424285, 1392448, 'France', 'Republic', 'Jacques Chirac', 2974, 'FR'),
('FRO', 'Faroe Islands', 'Europe', 'Nordic Countries', 1399, 0, 43000, 78.4, 0, 0, 'Føroyar', 'Part of Denmark', 'Margrethe II', 901, 'FO'),
('FSM', 'Micronesia', '', '', 0, 0, 0, 0, 0, 0, '', '', '', 0, ''),
...
('GIB', 'Gibraltar', 'Europe', 'Southern Europe', 6, 0, 25000, 79, 258, 0, 'Gibraltar', 'Dependent Territory of the UK', 'Elisabeth II', 915, 'GI'),
('GIN', 'Guinea', 'Africa', 'Western Africa', 245857, 1958, 7430000, 45.6, 2352, 2383, 'Guinée', 'Republic', 'Lansana Conté', 926, 'GN'),
('GLP', 'Guadeloupe', 'North America', 'Caribbean', 1705, 0, 456000, 77, 3501, 0, 'Guadeloupe', 'Overseas Department of France', 'Jacques Chirac', 919, 'GP'),
...
('GRD', 'Grenada', 'North America', 'Caribbean', 344, 1974, 94000, 64.5, 318, 0, 'Grenada', 'Constitutional Monarchy', 'Elisabeth II', 916, 'GD'),
('GRL', 'Greenland', 'North America', 'North America', 2166090, 0, 56000, 68.1, 0, 0, 'Kalaallit Nunaat/Grønland', 'Part of Denmark', 'Margrethe II', 917, 'GL'),
...
('GUF', 'French Guiana', 'South America', 'South America', 90000, 0, 181000, 76.1, 681, 0, 'Guyane française', 'Overseas Department of France', 'Jacques Chirac', 3014, 'GF'),
('GUM', 'Guam', 'Oceania', 'Micronesia', 549, 0, 168000, 77.8, 1197, 1136, 'Guam', 'US Territory', 'George W. Bush', 921, 'GU'),
('GUY', 'Guyana', 'South America', 'South America', 214969, 1966, 861000, 64, 722, 743, 'Guyana', 'Republic', 'Bharrat Jagdeo', 928, 'GY'),
('HKG', 'Hong Kong', 'Asia', 'Eastern Asia', 1075, 0, 6782000, 79.5, 166448, 173610, 'Xianggang/Hong Kong', 'Special Administrative Region of China', 'Jiang Zemin', 937, 'HK'),
('HMD', 'Heard Island and McDonald Islands', 'Antarctica', 'Antarctica', 359, 0, 0, 0, 0, 0, 'Heard and McDonald Islands', 'Territory of Australia', 'Elisabeth II', 0, 'HM'),
...
('IOT', 'British Indian Ocean Territory', 'Africa', 'Eastern Africa', 78, 0, 0, 0, 0, 0, 'British Indian Ocean Territory', 'Dependent Territory of the UK', 'Elisabeth II', 0, 'IO'),
...
('IRQ', 'Iraq', 'Asia', 'Middle East', 438317, 1932, 23115000, 66.5, 11500, 0, 'Al-´Iraq', 'Republic', 'Saddam Hussein al-Takriti', 1365, 'IQ'),
...
('KIR', 'Kiribati', 'Oceania', 'Micronesia', 726, 1979, 83000, 59.8, 41, 0, 'Kiribati', 'Republic', 'Teburoro Tito', 2256, 'KI'),
('KNA', 'Saint Kitts and Nevis', 'North America', 'Caribbean', 261, 1983, 38000, 70.7, 299, 0, 'Saint Kitts and Nevis', 'Constitutional Monarchy', 'Elisabeth II', 3064, 'KN'),
...
('LBR', 'Liberia', 'Africa', 'Western Africa', 111369, 1847, 3154000, 51, 2012, 0, 'Liberia', 'Republic', 'Charles Taylor', 2440, 'LR'),
...
('LCA', 'Saint Lucia', 'North America', 'Caribbean', 622, 1979, 154000, 72.3, 571, 0, 'Saint Lucia', 'Constitutional Monarchy', 'Elisabeth II', 3065, 'LC'),
...
('MAC', 'Macao', 'Asia', 'Eastern Asia', 18, 0, 473000, 81.6, 5749, 5940, 'Macau/Aomen', 'Special Administrative Region of China', 'Jiang Zemin', 2454, 'MO'),
...
('MCO', 'Monaco', 'Europe', 'Western Europe', 2, 1861, 34000, 78.8, 776, 0, 'Monaco', 'Constitutional Monarchy', 'Rainier III', 2695, 'MC'),
...
('MDV', 'Maldives', 'Asia', 'Southern and Central Asia', 298, 1965, 286000, 62.2, 199, 0, 'Dhivehi Raajje/Maldives', 'Republic', 'Maumoon Abdul Gayoom', 2463, 'MV'),
...
('MHL', 'Marshall Islands', 'Oceania', 'Micronesia', 181, 1990, 64000, 65.5, 97, 0, 'Marshall Islands/Majol', 'Republic', 'Kessai Note', 2507, 'MH'),
...
('MNP', 'Northern Mariana Islands', 'Oceania', 'Micronesia', 464, 0, 78000, 75.5, 0, 0, 'Northern Mariana Islands', 'Commonwealth of the US', 'George W. Bush', 2913, 'MP'),
...
('MSR', 'Montserrat', 'North America', 'Caribbean', 102, 0, 11000, 78, 109, 0, 'Montserrat', 'Dependent Territory of the UK', 'Elisabeth II', 2697, 'MS'),
('MTQ', 'Martinique', 'North America', 'Caribbean', 1102, 0, 395000, 78.3, 2731, 2559, 'Martinique', 'Overseas Department of France', 'Jacques Chirac', 2508, 'MQ'),
...
('MYS', 'Malaysia', 'Asia', 'Southeast Asia', 329758, 1957, 22244000, 70.8, 69213, 97884, 'Malaysia', 'Constitutional Monarchy', '', 0, ''),
('MYT', 'Mayotte', 'Africa', 'Eastern Africa', 373, 0, 149000, 59.5, 0, 0, 'Mayotte', 'Territorial Collectivity of France', 'Jacques Chirac', 2514, 'YT'),
('NAM', 'Namibia', 'Africa', 'Southern Africa', 824292, 1990, 1726000, 42.5, 3101, 3384, 'Namibia', 'Republic', 'Sam Nujoma', 2726, 'NA'),
('NCL', 'New Caledonia', 'Oceania', 'Melanesia', 18575, 0, 214000, 72.8, 3563, 0, 'Nouvelle-Calédonie', 'Nonmetropolitan Territory of France', 'Jacques Chirac', 3493, 'NC'),
('NER', 'Niger', 'Africa', 'Western Africa', 1267000, 1960, 10730000, 41.3, 1706, 1580, 'Niger', 'Republic', 'Mamadou Tandja', 2738, 'NE'),
('NFK', 'Norfolk Island', 'Oceania', 'Australia and New Zealand', 36, 0, 2000, 0, 0, 0, 'Norfolk Island', 'Territory of Australia', 'Elisabeth II', 2806, 'NF'),
...
('NIU', 'Niue', 'Oceania', 'Polynesia', 260, 0, 2000, 0, 0, 0, 'Niue', 'Nonmetropolitan Territory of New Zealand', 'Elisabeth II', 2805, 'NU'),
...
('NRU', 'Nauru', 'Oceania', 'Micronesia', 21, 1968, 12000, 60.8, 197, 0, 'Naoero/Nauru', 'Republic', 'Bernard Dowiyogo', 2728, 'NR'),
...
('PCN', 'Pitcairn', 'Oceania', 'Polynesia', 49, 0, 50, 0, 0, 0, 'Pitcairn', 'Dependent Territory of the UK', 'Elisabeth II', 2912, 'PN'),
...
('PLW', 'Palau', 'Oceania', 'Micronesia', 459, 1994, 19000, 68.6, 105, 0, 'Belau/Palau', 'Republic', 'Kuniwo Nakamura', 2881, 'PW'),
...
('PRI', 'Puerto Rico', 'North America', 'Caribbean', 8875, 0, 3869000, 75.6, 34100, 32100, 'Puerto Rico', 'Commonwealth of the US', 'George W. Bush', 2919, 'PR'),
('PRK', 'North Korea', 'Asia', 'Eastern Asia', 120538, 1948, 24039000, 70.7, 5332, 0, 'Choson Minjujuui In´min Konghwaguk (Bukhan)', 'Socialistic Republic', 'Kim Jong-il', 2318, 'KP'),
...
('PSE', 'Palestine', 'Asia', 'Middle East', 6257, 0, 3101000, 71.4, 4173, 0, 'Filastin', 'Autonomous Area', 'Yasser (Yasir) Arafat', 4074, 'PS'),
('PYF', 'French Polynesia', 'Oceania', 'Polynesia', 4000, 0, 235000, 74.8, 818, 781, 'Polynésie française', 'Nonmetropolitan Territory of France', 'Jacques Chirac', 3016, 'PF'),
('QAT', 'Qatar', 'Asia', 'Middle East', 11000, 1971, 599000, 72.4, 9472, 8920, 'Qatar', 'Monarchy', 'Hamad ibn Khalifa al-Thani', 2973, 'QA'),
('REU', 'Réunion', 'Africa', 'Eastern Africa', 2510, 0, 699000, 72.7, 8287, 7988, 'Réunion', 'Overseas Department of France', 'Jacques Chirac', 3017, 'RE'),
...
('SDN', 'Sudan', 'Africa', 'Northern Africa', 2505813, 1956, 29490000, 56.6, 10162, 0, 'As-Sudan', 'Islamic Republic', 'Omar Hassan Ahmad al-Bashir', 3225, 'SD'),
...
('SGS', 'South Georgia and the South Sandwich Islands', 'Antarctica', 'Antarctica', 3903, 0, 0, 0, 0, 0, 'South Georgia and the South Sandwich Islands', 'Dependent Territory of the UK', 'Elisabeth II', 0, 'GS'),
('SHN', 'Saint Helena', 'Africa', 'Western Africa', 314, 0, 6000, 76.8, 0, 0, 'Saint Helena', 'Dependent Territory of the UK', 'Elisabeth II', 3063, 'SH'),
('SJM', 'Svalbard and Jan Mayen', 'Europe', 'Nordic Countries', 62422, 0, 3200, 0, 0, 0, 'Svalbard og Jan Mayen', 'Dependent Territory of Norway', 'Harald V', 938, 'SJ'),
...
('SMR', 'San Marino', 'Europe', 'Southern Europe', 61, 885, 27000, 81.1, 510, 0, 'San Marino', 'Republic', '', 3171, 'SM'),
('SOM', 'Somalia', 'Africa', 'Eastern Africa', 637657, 1960, 10097000, 46.2, 935, 0, 'Soomaaliya', 'Republic', 'Abdiqassim Salad Hassan', 3214, 'SO'),
('SPM', 'Saint Pierre and Miquelon', 'North America', 'North America', 242, 0, 7000, 77.6, 0, 0, 'Saint-Pierre-et-Miquelon', 'Territorial Collectivity of France', 'Jacques Chirac', 3067, 'PM'),
('STP', 'Sao Tome and Principe', 'Africa', 'Central Africa', 964, 1975, 147000, 65.3, 6, 0, 'São Tomé e Príncipe', 'Republic', 'Miguel Trovoada', 3172, 'ST'),
...
('TCA', 'Turks and Caicos Islands', 'North America', 'Caribbean', 430, 0, 17000, 73.3, 96, 0, 'The Turks and Caicos Islands', 'Dependent Territory of the UK', 'Elisabeth II', 3423, 'TC'),
...
('TKL', 'Tokelau', 'Oceania', 'Polynesia', 12, 0, 2000, 0, 0, 0, 'Tokelau', 'Nonmetropolitan Territory of New Zealand', 'Elisabeth II', 3333, 'TK'),
...
('TMP', 'East Timor', 'Asia', 'Southeast Asia', 14874, 0, 885000, 46, 0, 0, 'Timor Timur', 'Administrated by the UN', 'José Alexandre Gusmão', 1522, 'TP'),
...
('TUV', 'Tuvalu', 'Oceania', 'Polynesia', 26, 1978, 12000, 66.3, 6, 0, 'Tuvalu', 'Constitutional Monarchy', 'Elisabeth II', 3424, 'TV'),
...
('UMI', 'United States Minor Outlying Islands', 'Oceania', 'Micronesia/Caribbean', 16, 0, 0, 0, 0, 0, 'United States Minor Outlying Islands', 'Dependent Territory of the US', 'George W. Bush', 0, 'UM'),
...
('VAT', 'Holy See (Vatican City State)', 'Europe', 'Southern Europe', 0, 1929, 1000, 0, 9, 0, 'Santa Sede/Città del Vaticano', 'Independent Church State', 'Johannes Paavali II', 3538, 'VA'),
('VCT', 'Saint Vincent and the Grenadines', 'North America', 'Caribbean', 388, 1979, 114000, 72.3, 285, 0, 'Saint Vincent and the Grenadines', 'Constitutional Monarchy', 'Elisabeth II', 3066, 'VC'),
...
('VGB', 'Virgin Islands', '', '', 0, 0, 0, 0, 0, 0, '', '', '', 0, ''),
('VIR', 'Virgin Islands', '', '', 0, 0, 0, 0, 0, 0, '', '', '', 0, ''),
...
('WLF', 'Wallis and Futuna', 'Oceania', 'Polynesia', 200, 0, 15000, 0, 0, 0, 'Wallis-et-Futuna', 'Nonmetropolitan Territory of France', 'Jacques Chirac', 3536, 'WF'),
...
('YUG', 'Yugoslavia', 'Europe', 'Southern Europe', 102173, 1918, 10640000, 72.4, 17000, 0, 'Jugoslavija', 'Federal Republic', 'Vojislav Koštunica', 1792, 'YU'),
...
CREATE TABLE `language` (
  ...
  `IsItOfficialLanguage` varchar(18) NOT NULL,
  `PercentageOfSpeakers` float NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `language` (`CountryCode`, `Language`, `IsItOfficialLanguage`, `PercentageOfSpeakers`) VALUES
('ABW', 'Dutch', 'T', 5.3),
('ABW', 'English', 'F', 9.5),
...
--
ALTER TABLE `city`
  MODIFY `ID` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4080;
...
--
ALTER TABLE `city`
  ADD CONSTRAINT `city_ibfk_1` FOREIGN KEY (`CountryCode`) REFERENCES `country` (`CountryCode`);

--
-- Constraints for table `language`
--
ALTER TABLE `language`
  ADD CONSTRAINT `language_ibfk_1` FOREIGN KEY (`CountryCode`) REFERENCES `country` (`CountryCode`);
COMMIT;
